...
class ProductCatalogServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SearchProducts = channel.unary_unary(
                ...
                _registered_method=True)
        self.SemanticSearchProducts = channel.unary_unary(
                '/hipstershop.ProductCatalogService/SemanticSearchProducts',
                request_serializer=demo__pb2.SemanticSearchRequest.SerializeToString,
                response_deserializer=demo__pb2.SearchProductsResponse.FromString,
                _registered_method=True)
...
class ProductCatalogServiceServicer(object):
    ...
    def SemanticSearchProducts(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_ProductCatalogServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SemanticSearchProducts': grpc.unary_unary_rpc_method_handler(
                    servicer.SemanticSearchProducts,
                    request_deserializer=demo__pb2.SemanticSearchRequest.FromString,
                    response_serializer=demo__pb2.SearchProductsResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class ProductCatalogService(object):
    ...
    @staticmethod
    def SemanticSearchProducts(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/hipstershop.ProductCatalogService/SemanticSearchProducts',
            demo__pb2.SemanticSearchRequest.SerializeToString,
            demo__pb2.SearchProductsResponse.FromString,
            options,
            channel_credentials,
            insecure,
