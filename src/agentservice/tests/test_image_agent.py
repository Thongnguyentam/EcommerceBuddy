...
async def test_image_agent_multiple_queries(mcp_url: str, tools_schema: dict):
    ...
    test_queries = [
        {
            "message": "Analyze this room image",
            "description": "Basic image analysis",
            "context": {
                "image_url": "https://i0.wp.com/thevettelfarm.com/wp-content/uploads/2022/10/DSC_6779-2-scaled.jpg?resize=1707%2C2560&ssl=1"
            }
        },
        {
        ...
        {
            "message": "Analyze the style and colors in this room photo",
            "description": "Style and color analysis",
            "context": {
                "image_url": "https://media.phillyvoice.com/media/images/102324-taylor-swift-airbnb-abs.2e16d0ba.fill-1200x630-c0.jpg"
            }
        }
    ]
